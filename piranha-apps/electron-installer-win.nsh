...
!define DOCKER_UNZIPPING_MSG "Unzipping Piranha Docker image. This may take several minute...s"
...
!if "$%BUNDLE_PIRANHA_IMAGE%" == "true"
  Section "Piranha Image"
    ...
    ${If} $0 != 0
      ...
      ExecWait 'cmd.exe /c echo ${DOCKER_LOADING_MSG} && docker load -i "$INSTDIR\resources\piranha-docker-image.tar.gz"' $0
